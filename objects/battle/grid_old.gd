...
# The grid's grid_size in rows and columns.
export var grid_size := Vector2(5, 5)
# The grid_size of a cell in pixels.
...
# Get size of the grid in pixels by Vector2
func get_real_size(grid_real_size:Vector2):
	grid_real_size = grid_size * cell_size 
	return grid_real_size
